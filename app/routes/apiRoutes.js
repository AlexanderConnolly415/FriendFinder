...
module.exports = function(app) {
    ...
    // Sets the get route for the api/friends route
    app.get('/api/friends', function(req, res) {
        res.json(friends);
    });

    // Sets the post route for the api/friends route
    app.post('/api/friends', function(req, res) {
        ...
        // For-each looping through the data in friends.js to find a match
        friends.forEach(function(friend) {
        		// Variables for comparing matches
            var matchedScoresArray = [];
            var totalDifference = 40;

            // Function to assist the addition reduce() below
            function add(total, num) {
                return total + num;
            }

            // Loops through each item of the scores arrays
            ...
            // Reduces the matchScoresArray into a single value in a variable
